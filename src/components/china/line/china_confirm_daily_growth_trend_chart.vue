<template>
  <div id="china-confirm-daily-growth-trend-chart"></div>
</template>
<script>
export default {
  data () {
  ...
  methods: {
    ...
    drawChart () {
      ...
      const dom = document.getElementById('china-confirm-daily-growth-trend-chart')
...
<style scoped>
#china-confirm-daily-growth-trend-chart {
  width: 100%;
  height: 100%;
}
</style>
