<template>
  <div id="hubei_except_wuhan_daily_growth_chart"></div>
</template>
<script>
export default {
  data () {
  ...
  methods: {
    ...
    drawChart () {
      ...
      const dom = document.getElementById('hubei_except_wuhan_daily_growth_chart')
...
<style scoped>
#hubei_except_wuhan_daily_growth_chart {
  width: 100%;
  height: 100%;
}
</style>
