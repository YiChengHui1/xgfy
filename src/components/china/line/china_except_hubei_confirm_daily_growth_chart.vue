<template>
  <div id="china_except_hubei_confirm_daily_growth_chart"></div>
</template>
<script>
export default {
  data () {
  ...
  methods: {
    ...
    drawChart () {
      ...
      const dom = document.getElementById('china_except_hubei_confirm_daily_growth_chart')
...
<style scoped>
#china_except_hubei_confirm_daily_growth_chart {
  width: 100%;
  height: 100%;
}
</style>
